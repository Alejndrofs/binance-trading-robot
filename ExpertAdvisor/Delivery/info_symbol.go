...
func NewSymbol(expert *ExpertAdvisorDelivery, name string, base *Asset, prof *Asset, minLot float64, minNotional float64, lotStep float64) (*SymbolInfo, error) {
...
func NewSyntheticSymbol(expert *ExpertAdvisorDelivery, name string, base *Asset, profit *Asset) (*SymbolInfo, error) {
	newSymbol := &SymbolInfo{
		Expert:     expert,
		SymbolName: name,
		Synthetic:  true,
