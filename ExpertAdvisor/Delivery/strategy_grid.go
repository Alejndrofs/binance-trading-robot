...
func NewGridStrategy(ea *ExpertAdvisorDelivery, symbol *SymbolInfo, grid float64, _range float64, trend bool) (*GridStrategy, error) {
...
func NewGridSyntheticStrategy(ea *ExpertAdvisorDelivery, symbolName string, base string, profit string, grid float64, _range float64, trend bool) (*GridStrategy, error) {
	strategy := &GridStrategy{
		Expert: ea,
		Trend:  trend,
	}
